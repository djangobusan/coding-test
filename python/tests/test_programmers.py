...
from src.programmers.personal_information_validity_period import personal_information_validity_period
...
class TestGreedy(unittest.TestCase):
    ...
    def test_personal_information_validity_period(self):
        self.assertEqual(personal_information_validity_period("2022.05.19", ["A 6", "B 12", "C 3"], ["2021.05.02 A", "2021.07.01 B", "2022.02.19 C", "2022.02.20 C"]), [1,3])
        self.assertEqual(personal_information_validity_period("2020.01.01", ["Z 3", "D 5"], ["2019.01.01 D", "2019.11.15 Z", "2019.08.02 D", "2019.07.01 D", "2018.12.28 Z"]), [1,4,5])